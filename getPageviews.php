...
$query = "SELECT * from analytics_profiles";
$result = mysqli_query($connection,$query);
    ...
    while ($row = $result->fetch_assoc()) {
        ...
        echo "sessions" . $results->totalsForAllResults['ga:sessions'];
        echo "bounces" . $results->totalsForAllResults['ga:bounces'];

        $query = "INSERT INTO analytics_results(analytics_profiles_id,date,sessions,bounces) VALUES(".$row['profileid'].",'".date('Y-m-d',$theday)."',".$results->totalsForAllResults['ga:sessions'].",".$results->totalsForAllResults['ga:bounces'].")";
        //echo $query;
